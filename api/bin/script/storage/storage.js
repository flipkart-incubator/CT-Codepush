...
exports.NameResolver = exports.getAccessSecret = exports.Permissions = exports.ReleaseMethod = exports.ErrorCode = void 0;
exports.clone = clone;
...
const getAccessSecret = async (secretName) => {
    try {
        ...
        throw error; // Rethrow to handle in higher layers if needed
    }
};
...
class NameResolver {
    ...
    resolveApp(accountId, name, permission) {
        console.log(accountId, name, permission, 'ResolveApp');
        return this._storage
            .getApps(accountId)
            .then((apps) => {
