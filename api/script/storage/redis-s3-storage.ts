...
export class RedisS3Storage implements storage.Storage {
  ...
  private googleStorageClient: Storage;
  private googleBucket: any;
  ...
  constructor() {
    ...
    q.all([storage.getAccessSecret(process.env.GOOGLE_CLIENT_EMAIL), storage.getAccessSecret(process.env.GOOGLE_PRIVATE_KEY)]).then(
